...
Widget wrapWithModel<T extends VoizeAffinityChromaLayerModel>({
  required T model,
...
T createModel<T extends VoizeAffinityChromaLayerModel>(
...
abstract class VoizeAffinityChromaLayerModel<W extends Widget> {
  ...
  VoizeAffinityChromaLayerModel setOnUpdate({
    bool updateOnChange = false,
...
class VoizeAffinityChromaLayerDynamicModels<
    T extends VoizeAffinityChromaLayerModel> {
  VoizeAffinityChromaLayerDynamicModels(this.defaultBuilder);
