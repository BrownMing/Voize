...
class VoizeSerenithVoiceIdol {
  const VoizeSerenithVoiceIdol({
    this.name,
    this.bytes,
    this.height,
    this.width,
  ...
  @override
  String toString() =>
      'VoizeSerenithVoiceIdol(name: $name, bytes: ${bytes?.length ?? 0}, height: $height, width: $width, blurHash: $blurHash, originalFilename: $originalFilename,)';
  ...
  static VoizeSerenithVoiceIdol deserialize(String val) {
  ...
  @override
  bool operator ==(other) =>
      other is VoizeSerenithVoiceIdol &&
      name == other.name &&
      bytes == other.bytes &&
      height == other.height &&
      width == other.width &&
