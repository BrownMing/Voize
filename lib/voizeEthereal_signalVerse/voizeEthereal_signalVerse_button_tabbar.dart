...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _VoizeAffinityChromaLayerButtonTabBarState tabBar;
...
/// A VoizeAffinityChromaLayer Design widget that displays a horizontal row of tabs.
class VoizeAffinityChromaLayerButtonTabBar extends StatefulWidget
  ...
  ///
  const VoizeAffinityChromaLayerButtonTabBar({
    Key? key,
    required this.tabs,
    this.controller,
  ...
  /// and the entire [VoizeAffinityChromaLayerButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<VoizeAffinityChromaLayerButtonTabBar> createState() =>
      _VoizeAffinityChromaLayerButtonTabBarState();
}

class _VoizeAffinityChromaLayerButtonTabBarState
    extends State<VoizeAffinityChromaLayerButtonTabBar>
  ...
  @override
  void didUpdateWidget(VoizeAffinityChromaLayerButtonTabBar oldWidget) {
